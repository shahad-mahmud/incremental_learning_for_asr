...
class ASR(torch.nn.Module):
    def __init__(self, configs: dict) -> None:
        ...
        self.dense1 = torch.nn.Linear(configs['n_mels'], 512, device=self.device)
        self.dense2 = torch.nn.Linear(512, configs['dense_units'], device=self.device)
    ...
    def forward(self, batch):
        ...
        # print(probalities.shape, spectograms.shape)
